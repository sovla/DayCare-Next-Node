...
import BoardUpdateComponent from '@src/Container/Page/BoardUpdate';
import { Provider } from 'react-redux';
import { mockStore } from '@src/Store/store';
import MockError from 'stories/mockError';

export default {
  title: 'Container/BoardUpdate',
...
} as ComponentMeta<typeof BoardUpdateComponent>;
...
const Template: ComponentStory<typeof BoardUpdateComponent> = (args) => (
  <BoardUpdateComponent {...args} review={dummyReview} />
);

export const BoardUpdate = Template.bind({});
